...
public class TextPrompt extends JLabel implements FocusListener, DocumentListener {
	...
	public TextPrompt(String text, JTextComponent component) { this(text, component, Show.ALWAYS); }
	...
	public void setShowPromptOnce(boolean showPromptOnce) { this.showPromptOnce = showPromptOnce; }
